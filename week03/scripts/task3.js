...
const divideNumbers = () => {
    let number1 = parseInt(document.getElementById('dividend').value)
    let number2 = parseInt(document.getElementById('divisor').value)
    let result = divide(number1, number2)
    document.getElementById('quotient').value = result.toFixed(2)
}
